...
export interface ApiMotoMoto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    FreioDianteiro: Schema.Attribute.String & Schema.Attribute.Required;
    FreioTraseiro: Schema.Attribute.String & Schema.Attribute.Required;
    Imagem: Schema.Attribute.Media<'images', true> & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::moto.moto'> &
      Schema.Attribute.Private;
    Marca: Schema.Attribute.String & Schema.Attribute.Required;
    Marchas: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: 7;
    ...
    publishedAt: Schema.Attribute.DateTime;
    Quilometragem: Schema.Attribute.Decimal &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
